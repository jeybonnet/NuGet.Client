...
namespace NuGet.PackageManagement.VisualStudio
{
    ...
    public sealed class LegacyPackageReferenceProject : BuildIntegratedNuGetProject
    {
            ...
            CancellationToken token)
        {
            ...
            await ProjectServices.References.AddOrUpdatePackageReferenceAsync(dependency);
        ...
        private async Task<PackageSpec> GetPackageSpecAsync()
        {
            ...
            var runtimes = _vsProjectAdapter.GetRuntimes();
            var supports = _vsProjectAdapter.Supports;
