...
namespace NuGet.PackageManagement.VisualStudio
{
        ...
        , IProjectSystemReferencesService
    {
        ...
        public async Task<IReadOnlyList<LibraryDependency>> GetPackageReferencesAsync(
        ...
        public async Task AddOrUpdatePackageReferenceAsync(LibraryDependency packageReference)
        {
            await _threadingService.JoinableTaskFactory.SwitchToMainThreadAsync();
