...
namespace NuGet.ProjectManagement
{
        ...
        , IDependencyGraphProject
    {
        ...
        public IMSBuildNuGetProjectSystem ProjectSystem { get; }
            ...
            CancellationToken token)
        {
            ...
            if (anyFrameworkToolsGroup != null)
            {
                ...
                if (!string.IsNullOrEmpty(initPS1RelativePath))
                {
                    ...
                    await ProjectSystem.ExecuteScriptAsync(packageIdentity, packageInstallPath, initPS1RelativePath, throwOnFailure: true);
                }
            }
            ...
            if (MSBuildNuGetProjectSystemUtility.IsValid(compatibleToolItemsGroup))
            {
                ...
                {
                    await ProjectSystem.ExecuteScriptAsync(packageIdentity, packageInstallPath, installPS1RelativePath, throwOnFailure: true);
                }
            }
            return true;
        }
        ...
        public override async Task<bool> UninstallPackageAsync(PackageIdentity packageIdentity, INuGetProjectContext nuGetProjectContext, CancellationToken token)
        {
            ...
            using (var packageStream = File.OpenRead(FolderNuGetProject.GetInstalledPackageFilePath(packageIdentity)))
            {
                ...
                if (MSBuildNuGetProjectSystemUtility.IsValid(compatibleToolItemsGroup))
                {
                    ...
                    {
                        var packageInstallPath = FolderNuGetProject.GetInstalledPath(packageIdentity);
                        await ProjectSystem.ExecuteScriptAsync(packageIdentity, packageInstallPath, uninstallPS1RelativePath, throwOnFailure: false);
                    }
                }
